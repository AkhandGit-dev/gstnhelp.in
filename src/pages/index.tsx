  ...
  return (
    <>
      ...
      <section className="bg-white py-16 border-b border-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Why Businesses Trust GSTN Help</h2>
            <p className="mt-3 text-base text-gray-600">We combine legal expertise with technical reconciliation to solve complex GST issues.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Trust Card 1 */}
            <div className="group bg-slate-50 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-blue-50 rounded-full -mr-10 -mt-10 transition-transform group-hover:scale-110 opacity-50"></div>
            ...
            {/* Trust Card 2 */}
            <div className="group bg-slate-50 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-green-50 rounded-full -mr-10 -mt-10 transition-transform group-hover:scale-110 opacity-50"></div>
              <div className="relative z-10">
            ...
            {/* Trust Card 3 */}
            <div className="group bg-slate-50 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-purple-50 rounded-full -mr-10 -mt-10 transition-transform group-hover:scale-110 opacity-50"></div>
              <div className="relative z-10">
      ...
      <section className="container mx-auto px-6 py-16">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-3 text-gray-900">Our Professional Services</h2>
        <p className="text-center text-base text-gray-600 mb-10 max-w-2xl mx-auto">Affordable, expert-led solutions for your GST compliance needs.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Service 1 */}
          <div className="group relative bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <button onClick={() => setSelectedService('GST Notice Reply & Resolution')} className="w-full mt-6 bg-gray-900 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-600 transition-colors text-sm">
              Avail Service
            </button>
          </div>
          ...
          <div className="group relative bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <button onClick={() => setSelectedService('GST Refund Advisory & Filing')} className="w-full mt-6 bg-gray-900 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-600 transition-colors text-sm">
              Avail Service
            </button>
          </div>
          ...
          <div className="group relative bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <button onClick={() => setSelectedService('ITC Reconciliation & Recovery')} className="w-full mt-6 bg-gray-900 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-600 transition-colors text-sm">
              Avail Service
            </button>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-blue-900 to-slate-900 py-16 text-white">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">How We Resolve Your Issue</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div className="relative">
              <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-lg shadow-green-500/30">1</div>
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-lg shadow-green-500/30">2</div>
              <h4 className="font-semibold text-lg">Free Review</h4>
              <p className="text-blue-200 text-sm mt-2">Expert assessment of your case.</p>
            </div>
            <div className="relative">
              <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-lg shadow-green-500/30">3</div>
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-lg shadow-green-500/30">4</div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-10 text-gray-900">Client Stories</h2>
      ...
      <section id="lead-form" className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div className="lg:sticky lg:top-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Get a Free GST Issue Review</h2>
