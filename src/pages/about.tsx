    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-3">About GSTN Help</h1>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Expert Legal Defense</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Outcome-Focused</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Confidential & Secure</h3>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-10 text-center text-white shadow-lg">
          <h2 className="text-2xl font-bold mb-5">Ready to resolve your GST issue?</h2>
          <Link href="/submit" className="inline-block bg-white text-blue-800 font-bold px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors shadow-md">
